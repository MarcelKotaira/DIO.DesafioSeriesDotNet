using DIO.DesafioSeriesDotNet.Dominio;

namespace DIO.DesafioSeriesDotNet.Console
{
	class Program
	{
		...
		private static void AtualizarSerie()
		{
			...
			foreach (int i in Enum.GetValues(typeof(GeneroSerie)))
			{
				System.Console.WriteLine("{0}-{1}", i, Enum.GetName(typeof(GeneroSerie), i));
			}
			...
			Serie atualizaSerie = new Serie(id: indiceSerie,
										genero: (GeneroSerie)entradaGenero,
